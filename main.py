...
PAYMENT_CHANNEL = "@TONixshift_bot" #add payment channel here including the '@' sign
OWNER_ID = 1725235943 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@TONixshift_bot"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
